...
class MinHeap:
    ...
    def percolate_down(self, node_index):
        ...
        while k > 1:
            ...
            while parent_node_index < k // 2:
                ...
                # Set temp_node_index to current node_index
                ...
                # If index is now one of nodes children
    ...
    def build_heap(self, da: DynamicArray) -> None:
        """
        Receives a dynamic array with objects in any order and builds a properMinHeap from them
        """
        ...
        # node_index is parent of last inputted node
        node_index = (da.length() - 1) // 2 - 1
        # Percolate down at each parent node
        while node_index != -1:
            self.percolate_down(node_index)
            node_index -= 1
